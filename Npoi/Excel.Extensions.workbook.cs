...
//    {
//        static public ICellStyle Highlight(this IWorkbook workbook, ICellStyle style, Excel.Color color, FillPattern fillPattern = FillPattern.SolidForeground, bool createOnlyUniqueStyle = true)
//        {
//            return workbook.highlight(style, createOnlyUniqueStyle, color, fillPattern);
//        }
...
//        /// </summary>
//        static internal ICellStyle highlight(this IWorkbook workbook, ICellStyle style, bool createOnlyUniqueStyle, Excel.Color color, FillPattern fillPattern = FillPattern.SolidForeground)
//        {
...
//                {
//                    cs = style == null ? (XSSFCellStyle)workbook.CreateUnregisteredStyle() : (XSSFCellStyle)workbook.CloneUnregisteredStyle(style);
//                    cs.SetFillForegroundColor(new XSSFColor(color.RGB));
//                    cs.FillPattern = fillPattern;
//                    return workbook.GetRegisteredStyle(cs);
//                }
...
//                {
//                    if (style == null)
//                        cs = workbook.CreateUnregisteredStyle();
//                    else
//                        cs = workbook.CloneUnregisteredStyle(style);
...
//        /// <returns></returns>
//        static public ICellStyle GetRegisteredStyle(this IWorkbook workbook, ICellStyle unregisteredStyle, IWorkbook unregisteredStyleWorkbook = null)
//        {
...
//            ICellStyle style = workbook.FindEqualStyles(unregisteredStyle, unregisteredStyleWorkbook).FirstOrDefault();
//            if (style != null)
//                return style;
//            style = workbook.CreateCellStyle();
//            return workbook.CopyStyle(unregisteredStyle, style);
//        }

//        static public IEnumerable<ICellStyle> FindEqualStyles(this IWorkbook workbook, ICellStyle style, IWorkbook styleWorkbook = null)
//        {
...
//            foreach (ICellStyle s in workbook.GetStyles())
//            {
//                if (styleWorkbook == null || styleWorkbook == workbook)
...
//        static public ICellStyle CopyStyle(this IWorkbook workbook, ICellStyle fromStyle, ICellStyle toStyle, IWorkbook toStyleWorkbook = null)
//        {
...
//            else
//            {
//                IFont f2 = workbook.GetRegisteredFont(f1.IsBold, (IndexedColors)Enum.ToObject(typeof(IndexedColors), f1.Color), (short)f1.FontHeight, f1.FontName, f1.IsItalic, f1.IsStrikeout, f1.TypeOffset, f1.Underline);
//                toStyle.SetFont(f2);
//            }
//            return toStyle;
//        }

//        static public ICellStyle CreateUnregisteredStyle(this IWorkbook workbook)
//        {
//            if (workbook is XSSFWorkbook)
//            {
...
//        /// <returns></returns>
//        static public ICellStyle CloneUnregisteredStyle(this IWorkbook workbook, ICellStyle fromStyle, IWorkbook cloneStyleWorkbook = null)
//        {
//            ICellStyle toStyle = workbook.CreateUnregisteredStyle();
//            return workbook.CopyStyle(fromStyle, toStyle, cloneStyleWorkbook);
//        }
...
//        /// <returns></returns>
//        static public IFont GetRegisteredFont(this IWorkbook workbook, bool bold, IndexedColors color, short fontHeightInPoints, string name, bool italic = false, bool strikeout = false, FontSuperScript typeOffset = FontSuperScript.None, FontUnderlineType underline = FontUnderlineType.None)
//        {
...
//        static public IEnumerable<ICellStyle> GetStyles(this IWorkbook workbook)
//        {
...
//        static public IEnumerable<ICellStyle> GetUnusedStyles(this IWorkbook workbook, params short[] ignoredStyleIds)
//        {
//            bool usedBySheet(ISheet sheet, ICellStyle style)
//            {
//                for (int r = 0; r <= sheet.LastRowNum; r++)
//                {
//                    IRow row = sheet.GetRow(r, false);
//                    if (row == null)
//                        continue;
...
//        /// </summary>
//        /// <exception cref="Exception"></exception>
//        static public void OptimiseStyles(this IWorkbook workbook)
//        {
