...
//    static public partial class ExcelExtensions
//    {
//        static public void Move(this ICell fromCell, int toCellY, int toCellX, Action<ICell> onFormulaCellMoved = null, ISheet toSheet = null)
//        {
//            ICell toCell = fromCell.Copy(toCellY, toCellX, toSheet);
//            if (fromCell != null)
...
//        static public ICell Copy(this ICell fromCell, int toCellY, int toCellX, ISheet toSheet = null)
//        {
//            if (toSheet == null)
...
//            else
//            {
//                ICell toCell = toSheet.GetCell(toCellY, toCellX, true);
//                Copy(fromCell, toCell);
//                return toCell;
//            }
//        }

//        static public void Copy(this ICell fromCell, ICell toCell)
//        {
//            toCell.SetBlank();
...
//        static public Excel.Range GetMergedRange(this ICell cell)
//        {
//            return cell.Sheet.getMergedRange(cell.RowIndex + 1, cell.ColumnIndex + 1);
//        }
>>>>>>> Stashed changes
...
//        static public IEnumerable<Excel.Image> GetImages(this ICell cell)
//        {
//            return cell.Sheet.GetImages(cell.Y(), cell.X());
//        }
//    }
//}
>>>>>>> Stashed changes
