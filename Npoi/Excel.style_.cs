...
namespace Cliver
{
    public partial class Excel : IDisposable
    {
        ...
        {
            return excel.Workbook.highlight(style, createOnlyUniqueStyle, color, fillPattern);
        }
        ...
        {
            return Workbook.GetRegisteredStyle(unregisteredStyle, unregisteredStyleWorkbook);
        }

        public IEnumerable<ICellStyle> FindEqualStyles(ICellStyle style, IWorkbook styleWorkbook = null)
        {return Workbook.FindEqualStyles(style, styleWorkbook);
        }
        ...
        {
            return Workbook.CopyStyle(fromStyle, toStyle, toStyleWorkbook);
        }

        public ICellStyle CreateUnregisteredStyle()
        {
           return Workbook.CreateUnregisteredStyle();
        }
        ...
        {return Workbook.CloneUnregisteredStyle(fromStyle, cloneStyleWorkbook);
        ...
        {return Workbook.GetRegisteredFont(bold, color, fontHeightInPoints,name,italic,strikeout,typeOffset,underline);
        }
        ...
        {
            return GetUnusedStyles(ignoredStyleIds);
        }
